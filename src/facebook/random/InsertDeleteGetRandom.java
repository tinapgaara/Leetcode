 ...
 * 380. Insert Delete InsertDeleteGetRandom O(1)
    ...
    */
    ...
    public boolean remove(int val) {
        if (randomIndex.containsKey(val)) {
            ...
            // swap tail with real deleted element
            if (removedIndex < randomList.size()) {
                randomList.set(removedIndex, tailVal);
                randomIndex.put(tailVal, removedIndex); // important !!! need to change map as well
            }
            return true;
        }
        return false;
